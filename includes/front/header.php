					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +254703849766</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> info@4limo.tech</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><img src="assets/front/images/home/logo2.png" alt="" /></a>
						</div>
